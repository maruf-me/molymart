  ...
  return (
    ...
    >
      <button
        type="button"
        className={cn(
          "pointer-events-auto h-fit w-fit rounded-md bg-zinc-50 p-2 transition-opacity duration-300 dark:bg-zinc-950 shadow-md border border-dark-40",
          alwaysShow
            ? "opacity-100"
      ...
      >
        <ChevronLeft className="stroke-dark-90 dark:stroke-zinc-50" size={16} />
      </button>
      <button
        type="button"
        className={cn(
      ...
      >
        <ChevronRight
          className="stroke-dark-90 dark:stroke-zinc-50"
          size={16}
        />
      </button>
    </div>
